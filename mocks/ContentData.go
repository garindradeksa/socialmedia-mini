...
func (_m *ContentData) Add(userID uint, newContent content.Core) (content.Core, error) {
	...
	var r0 content.Core
	var r1 error
	if rf, ok := ret.Get(0).(func(uint, content.Core) (content.Core, error)); ok {
		return rf(userID, newContent)
	}
...
func (_m *ContentData) Update(userID uint, contentID uint, updatedContent content.Core) (content.Core, error) {
	...
	var r0 content.Core
	var r1 error
	if rf, ok := ret.Get(0).(func(uint, uint, content.Core) (content.Core, error)); ok {
		return rf(userID, contentID, updatedContent)
	}
...
func NewContentData(t interface {
	mock.TestingT
	Cleanup(func())
}) *ContentData {
	mock := &ContentData{}
